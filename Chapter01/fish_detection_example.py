...
def load_training_samples():
    ...
    return train_input_variables, train_label, train_input_variables_id
...
def load_normalize_testing_samples():
    ...
    # Converting the loaded and resized data into Numpy format
    testing_samples = np.array(testing_samples, dtype=np.uint16)
...
def create_model_with_kfold_cross_validation(nfolds=10):
    ...
    for train_index, test_index in kf:
       ...
       current_model_score = log_loss(validation_samples_Y, predictions_of_validation_samples)
